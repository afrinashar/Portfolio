      ...
      <div className="projects-container">
        <section className="project-section">
          ...
          <h1 className="live-link">
            Live Link: <a href="https://gemini-image-tau.vercel.app/" target="_blank" rel="noreferrer">Image Analyzer</a>
          </h1>
        </section>
        ...
        <section className="project-section">
          ...
          <h1 className="live-link">
            Live Link: <a href="https://gemini-wfk2.vercel.app/" target="_blank" rel="noreferrer">GPT</a>
          </h1>
        </section>
      </div>
    </>
