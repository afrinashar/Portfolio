...
export const ProjectsAI = () => {
  return (
    <main className="projects-container" aria-label="AI Projects">
      <Link to={-1} className="btn btn-light sticky-button" aria-label="Go Back">Back</Link>
      <section className="project-section" aria-label="AI Image Analyzer">
        <header>
        ...
        <div className="video-container">
          <video controls muted width="100%" className="project-video" title="AI Image Analyzer Demo" loading="lazy">
            <source src={image} type="video/mp4" />
            Your browser does not support the video tag.
          </video>
        </div>
        <h3 className="live-link">
          Live Link: <a href="https://gemini-image-tau.vercel.app/" target="_blank" rel="noreferrer" title="AI Image Analyzer Live Demo">Image Analyzer</a>
        </h3>
      </section>
      <section className="project-section" aria-label="Custom GPT Project">
        <header>
        ...
        <div className="video-container">
          <video controls muted width="100%" className="project-video" title="Custom GPT Project Demo" loading="lazy">
            <source src={gpt} type="video/mp4" />
            Your browser does not support the video tag.
          </video>
        </div>
        <h3 className="live-link">
          Live Link: <a href="https://gemini-wfk2.vercel.app/" target="_blank" rel="noreferrer" title="Custom GPT Project Live Demo">GPT</a>
        </h3>
      </section>
    </main>
  );
